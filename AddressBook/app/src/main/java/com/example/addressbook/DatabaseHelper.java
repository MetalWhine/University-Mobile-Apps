...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_3 = "MOBILEPHONE";
    ...
    //adding a record
    public boolean insertData(String name, String mobilephone, String email) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        //This class is used to store a set of values that the ContentResolver can process
        contentValues.put(COL_2, name);
        contentValues.put(COL_3, mobilephone);
    ...
    public boolean updateRecord(String id, String name, String mobilephone,
                                String email){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
